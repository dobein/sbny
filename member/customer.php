...
?>
			<table width="94%" align=center border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="33" style="padding-left:12px;"><img src="<?= _WEB_BASE_DIR ?>/images/ico_home.gif" align="absmiddle"> &nbsp; Home  >  <span class="b">Support</span></td>
				</tr>
				<tr>
	...
	<table width="100%" align=center border=0 cellpadding=0 cellspacing=0 >
		<tr>
			<td height=35 align=left class="title_font" bgcolor=#f4f4f4>&nbsp;&nbsp;<b>Support</b></td>
		</tr>
	</table>
	<br>
					...
					if($g_total < $g_cols)
						...
						$g_cols = $g_total;
								...
								for($j=0; $j < $g_cols; $j++,$i++)
										...
										//$g_obj[name] = iconv("UTF-8","EUC-KR",$g_obj[name]);
										...
										if($g_obj[seq_no])
											...
											echo "
														<td width=50% height=35>
																	...
																	<tr> 
																	  <td height=25  align=left>&nbsp;<img src=../images/handle.png>&nbsp;<a href=customer.php?no=$g_obj[seq_no]&pos=$g_obj[pos] >$g_obj[name] ({$n_num})</a></td>	
																	</tr>
																  </table>
														</td>
...
<table width=98% align=center border=0 cellpadding=0 cellspacing=0 >
	<tr>
		<td height=30  align=left class="style1">&nbsp;<b><?= $f_row1[name]; ?></b></td>
	</tr>
