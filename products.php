<?
	...
	if($category_info[c_code1])
	{
		$qry_code1 = "&& a.p_code1 = '$category_info[c_code1]'";
	}
	if($category_info[c_code2])
	{
		$qry_code2 = "&& a.p_code2 = '$category_info[c_code2]'";
	}
	if($category_info[c_code3])
	{
		$qry_code3 = "&& a.p_code3 = '$category_info[c_code3]'";
	}
