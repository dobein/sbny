...
$request['TransactionDetail'] = array('CustomerTransactionId' => ' *** Service Availability Request v4 using PHP ***');
$request['Version'] = array('ServiceId' => 'pmis', 'Major' => '5', 'Intermediate' => '0', 'Minor' => '0');
$request['Origin'] = array('PostalCode' => '77510', // Origin details
                                                         'CountryCode' => 'US');
$request['Destination'] = array('PostalCode' => '38110', // Destination details
                                                              'CountryCode' => 'US');
$request['ShipDate'] = getProperty('shipdate');
